      ...
      <div className='flex w-full max-w-sm mx-auto overflow-hidden bg-gray-50 rounded-lg shadow-lg  lg:max-w-4xl '>
        <div className='w-full px-6 py-8 md:px-8 md:w-1/2'>
          ...
          <div
            ...
            className='flex hover:text-white hover:bg-[#D39D55]  cursor-pointer items-center justify-center mt-4  transition-colors duration-300 transform border rounded-lg '
          >
            <div className=' py-2'>
